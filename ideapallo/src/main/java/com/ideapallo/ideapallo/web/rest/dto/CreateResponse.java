...
public class CreateResponse implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final CreateResponse other = (CreateResponse) obj;
    ...
    public String toString() {
        return "CreateResponse[" + "id=" + id + ", username=" + username + ", role=" + role + ", email=" + email + ", emailVerificationCodeTimestamp=" + emailVerificationCodeTimestamp
                + ", emailVerified=" + emailVerified + ", resetPasswordCodeTimestamp=" + resetPasswordCodeTimestamp + ", facebookId=" + facebookId + "]";
    }
