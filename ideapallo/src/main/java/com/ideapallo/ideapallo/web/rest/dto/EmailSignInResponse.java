...
public class EmailSignInResponse implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EmailSignInResponse other = (EmailSignInResponse) obj;
    ...
    public String toString() {
        return "EmailSignInResponse[" + "id=" + id + ", username=" + username + ", role=" + role + ", email=" + email + "]";
    }
