...
public class ReadIdeaResponse implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ReadIdeaResponse other = (ReadIdeaResponse) obj;
    ...
    public String toString() {
        return "ReadIdeaResponse[" + "id=" + id + ", title=" + title + ", content=" + content + ", idealistId=" + idealistId + "]";
    }
